...
//             ? format(new Date(interviewDetail?.created_at), 'MMM dd, yyyy') 
//             : ''; 
...
//                     <h2 className="flex gap-1 items-center text-sm font-bold mt-1"><Clock className="h-4 w-4"/>{interviewDetail?.duration}</h2>
//                 </div>
//                 <div className="mt-4">
//                     <h2 className="text-sm text-gray-500">Created On</h2>
//                     <h2 className="flex gap-1 items-center text-sm font-bold mt-1"><Calendar className="h-4 w-4"/>{formattedDate}</h2>
//                 </div>
//                {interviewDetail?.type&& <div className="mt-4">
//                     <h2 className="text-sm text-gray-500">Type</h2>
//                     <h2 className="flex gap-1 items-center text-sm font-bold mt-1"><Tag className="h-4 w-4"/>{JSON.parse(interviewDetail?.type)}</h2>
//                 </div>}
//             </div>
//             <div>
//                 <h2 className="font-bold mt-5">Job Description</h2>
//                 <p className="text-xs mt-2">{interviewDetail?.jobDescription}</p>
//             </div>
//             <div>
//                 <h2 className="font-bold mt-5">Interview Question</h2>
//                 {/* <p className="text-xs mt-2">{interviewDetail?.questionList}</p> */}
//             </div>
